...
class ELBigslime : public ELEnemy
{
private:
	int m_frameCount;
	int m_oldFrameCount;
	...
	void jump(const ELMap& map, int jumpH, ELObjectInfo& object, const Point &camerapos);
...
public:
	ELBigslime(const ELEnemyName& Name,
	...
	Point getBurstPos() const {return m_coreRect.center;}
